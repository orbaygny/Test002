...
public class PrometeoEditor : Editor
{
    ...
    private SerializedProperty steerWheelTransform;
    private void OnEnable()
    {
        ...
        steerWheelTransform = SO.FindProperty("steerWheelTransform");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(steerWheelTransform, new GUIContent("Steer W Transform: "));
        EditorGUILayout.EndToggleGroup();
