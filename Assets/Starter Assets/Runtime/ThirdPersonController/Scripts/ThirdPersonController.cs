...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public bool MoveToCarDoor;
        public Transform DoorToApproach;
        // cinemachine
        ...
        public void SetDoorToApproach(Transform door)
        {
            DoorToApproach = door;
            MoveToCarDoor = true;
        ...
        private void MoveToDoor()
        {
            ...
            // normalise input direction
            Vector3 inputDirection = (movePos - transform.position).normalized; //new Vector3(_input.move.x, 0.0f, _input.move.y).normalized;
